...
with open(output_file,"w") as f:
    ...
    f.write(f"----------------------------")
    f.write("\n")
    f.write(f"Khan: {khan_percent:.2f}% ({candidate.get('Khan')})")
    f.write("\n")
    f.write(f"Correy: {correy_percent:.2f}% ({candidate.get('Correy')})")
    f.write("\n")
    f.write(f"Li: {li_percent:.2f}% ({candidate.get('Li')})")
    f.write("\n")
    f.write(f"""O'Tooley: {otooley_percent:.2f}% ({candidate.get("O'Tooley")})""")
    f.write("\n")
    f.write(f"----------------------------")
    f.write("\n")
